...
<template>
  <div>
    ...
    <div class="row">
      <div class="col-md-2">
        <b-button variant="outline-primary" @click="addNode()" style="margin-right: 10px" v-b-tooltip.hover
          title="Add Node">
      ...
      <div class="col-md-2">
        <b-button variant="outline-primary" @click="goToTrend()">
          <ChartLine class="addnode" />
          See trend
        </b-button>
      </div>
      <div class="col-md-2">
        <b-button variant="outline-primary" @click="goToReport()">
      ...
      <div class="col-md-2">
        <b-button class="glanceBtn" variant="outline-primary" @click="AtGlance()" style="margin-right: 10px"
          v-b-tooltip.hover title="At Glance">
    ...
    <b-tabs>
      ...
      <b-tab>
        <template #title>
          All Cards
          <b-badge>{{ sensors.length }}</b-badge>
        </template>
        <Cards v-if="sensors && !loading" :sensors="sensors" />
      </b-tab>
...
console.log("again checking sample");
</script>
...
.drk {
  ...
  background: linear-gradient(rgb(0, 0, 0), rgb(112 212 47), rgb(1, 35, 5));
  height: 100px;
  width: 50px;
